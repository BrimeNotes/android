...
public class CreateNotesActivity extends AppCompatActivity {
    ...
    private class Csnote extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                try {
                    ...
                    Toast.makeText(CreateNotesActivity.this, message, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
                br.close();
        ...
        final Dialog dialog = new Dialog(CreateNotesActivity.this);
                ...
                positive.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (id == R.id.radioPublic) {
                             ...
                             */
                                new Csnote(CreateNotesActivity.this).execute(note_title,note_desc,String.valueOf(parent.getItemAtPosition(position)));
//
                            Log.i("hello", note_title + "   " + note_desc);
                            finish();
                            Toast.makeText(CreateNotesActivity.this, "Private segment", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(CreateNotesActivity.this, "Please choose Access Method", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                });
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(CreateNotesActivity.this, String.valueOf(parent.getItemIdAtPosition(0)), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
