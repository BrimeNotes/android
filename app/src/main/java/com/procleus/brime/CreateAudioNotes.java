...
public class CreateAudioNotes extends AppCompatActivity {
    ...
    /*Note s Creating Function Normal Like create Notes*/
    ...
    private void CustomDialog(View v,final Boolean isLoggedIn) {
        final Dialog dialog = new Dialog(CreateAudioNotes.this);
        ...
        final Notes tn =new Notes(CreateAudioNotes.this);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                positive.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (id == R.id.radioPublic) {
                            ...
                            finish();
                            Toast.makeText(CreateAudioNotes.this, String.valueOf(parent.getItemAtPosition(position)), Toast.LENGTH_SHORT).show();
                            finish();
                        } else if (id == R.id.radioPrivate) {
                            Notes tn = new Notes(CreateAudioNotes.this);
                            EditText title = (EditText) findViewById(R.id.noteTitle);
                            EditText note = (EditText) findViewById(R.id.note);
                            String note_desc, note_title;
                            note_desc = note.getText().toString();
                            ...
                            Log.i("hello", note_title + "   " + note_desc);
                            finish();
                            Toast.makeText(CreateAudioNotes.this, "Private segment", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(CreateAudioNotes.this, "Please choose Access Method", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                });
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(CreateAudioNotes.this, String.valueOf(parent.getItemIdAtPosition(0)), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
